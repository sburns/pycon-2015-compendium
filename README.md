...
[Keynote](https://www.youtube.com/watch?v=LOZk5ttyC9Y) from Catherine Bracy

| Speaker | Title (Video link where possible) |
| ------- | --------------------------------- |
| Kurt Grandis | [Exploring Minecraft and Python: Learning to Code Through Play](https://www.youtube.com/watch?v=WsPQDuHt__w)
| Kyle Kastner | [Machine Learning 101](https://www.youtube.com/watch?v=r-1XJBHot58) |
| lvh | [Building secure systems](https://www.youtube.com/watch?v=PjcTwqYSk-E) |
| Brett Slatkin | [How to Be More Effective with Functions](https://www.youtube.com/watch?v=WjJUPxKB164) |
| Adam Palay | ["Words, words, words": Reading Shakespeare with Python](https://www.youtube.com/watch?v=EoWG0lavg9U) |
| Ryan Kelley | [PyPy.js: What? How? Why?](https://www.youtube.com/watch?v=PiBfOFqDIAI) |
| Viviane Pons | [Experimental pure mathematics using Sage](https://www.youtube.com/watch?v=3LZiZKgVjaU) |
| Ashwini Oruganti | [Introduction to HTTPS: A Comedy of Errors](https://www.youtube.com/watch?v=HqnUKTjxI1E) |
| Andrew Godwin | [What can programmers learn from pilots?](https://www.youtube.com/watch?v=we4G_X91e5w) |
| Paul Hildebrandt | Inside the Hat: Python @ Walt Disney Animation Studios |
| Cory Benfield | [Hyperactive: HTTP/2 and Python](https://www.youtube.com/watch?v=ACXVyvm5eTc) |
| Soups Ranjan | [Data Science in Advertising: Or a future when we love ads](https://www.youtube.com/watch?v=HZTgLuOpFU8) |
| Benjamin Peterson | [A Dive into TLS](https://www.youtube.com/watch?v=4o-xqqidvKA) |
...
| lvh | [Distributed Systems 101](https://www.youtube.com/watch?v=YAFGQurdJ3U) |
...
| Benoit Chesnau | [What Python can learn from Erlang?](https://www.youtube.com/watch?v=EmICpC_QmhI) |
| David Baumgold | [Advanced Git](https://www.youtube.com/watch?v=4EOZvow1mk4) |
| Frank Stratton | [Smart services & smart clients: How micro-services change the way you build and deploy code.](https://www.youtube.com/watch?v=NYVUn8T-0qA) |
| Michelle Fullwood | [Grids, Streets and Pipelines: Building a linguistic street map with scikit-learn](https://www.youtube.com/watch?v=MIFOTFdtK2k) |
| Miriam Lauter | [Make your own Smart Air Conditioner](https://www.youtube.com/watch?v=MILdMBgxdq8) |
| Dan Callahan | [My Python's a little Rust-y](https://www.youtube.com/watch?v=3CwJ0MH-4MA) |
...
| Titus Brown | [How to interpret your own genome using (mostly) Python.](https://www.youtube.com/watch?v=jV4YMQHZmMk) |
| Jenny Cheng | [3D Print Anything with the Blender API](https://www.youtube.com/watch?v=ikcHP0Hd8Kc) |
| Raymond Hettinger | [Super considered super!](https://www.youtube.com/watch?v=EiOglTERPEo) |
| Melanie Warrick | [Neural Nets for Newbies](https://www.youtube.com/watch?v=g-BJSl4zV_g) |
| Miguel Grinberg | [Is Your REST API RESTful?](https://www.youtube.com/watch?v=pZYRC8IbCwk) |
| Jake VanderPlas | [Losing your Loops: Fast Numerical Computing with NumPy](https://www.youtube.com/watch?v=EEUXKG97YRw) |
| Dan Callahan | [Fire your supervisord: running Python apps on CoreOS](https://www.youtube.com/watch?v=jCor69OeR0g) |
...
| Chris McDonough | [Using Supervisor For Fun And Profit](https://www.youtube.com/watch?v=p0iQfT85IvM) |
| Jeff Schenck | [The REST Ascendancy](https://www.youtube.com/watch?v=HxP0lQCCiVo) |
| Trevor Bekolay | [How to build a brain with Python](https://www.youtube.com/watch?v=7hvpoLKJHOw) |
| Josh Triplett | [Porting Python to run without an OS](https://www.youtube.com/watch?v=bYQ_lq5dcvM) |
| Sarina Canelake | [I18N: World Domination the Easy Way](https://www.youtube.com/watch?v=UOOMFGURr5I) |
...
| Julia Evans | [Systems programming as a swiss army knife](https://www.youtube.com/watch?v=5v6o-VsLAew) |
...
| Andreas Dewes | [Learning from other's mistakes: Data-driven analysis of Python code](https://www.youtube.com/watch?v=rN0kNQLDYCI) |
...
| Nina Zakharenko | [Technical Debt - The code monster in everyone's closet](https://www.youtube.com/watch?v=JKYktDRoRxw) |
...
| Christine Spang | [To ORM or not to ORM](https://www.youtube.com/watch?v=Sadng6tR7Q4) |
| Dan Tracy | [Ship it: Deployments with Pip](https://www.youtube.com/watch?v=aD2CfKQB5xM) |
| Olivier Grisel | [Build and test wheel packages on Linux, OSX & Windows](https://www.youtube.com/watch?v=d-p6lJJObLU) |
| Allison Kaptur | [Exploring is never boring: understanding CPython without reading the code](https://www.youtube.com/watch?v=ZSIRGLmQTLk) |
| en zyme, Hakim Bouatou, Jon Henner | [Pythons are Deaf, So are Some Pythonistas](https://www.youtube.com/watch?v=-LVlzIOxbAE) |
| Elizabeth Ramirez | [Graph Database Patterns in Python](https://www.youtube.com/watch?v=fNAzyZZZ-IQ) |
